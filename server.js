...
app.get("/", (req, res) => res.send("Check the console output"));
...
const tokenizablePhrase =
  "I've not yet seen 'THOR: RAGNAROK'; I've heard it's a great movie though. What'd you think of it?";
...
console.log(
  new natural.WordTokenizer()
    .tokenize("Writing and write, lucky and luckies, part parts and parted")
...
console.log(
  compromise("Hey Siri, order me a pizza from John's pizzeria")
    .match("#Noun [#Verb me a #Noun+ *+ #Noun+]")
    .out("text")
);
